...
export async function GET(req: AuthenticatedMedusaRequest, res: MedusaResponse<PaginatedOutput<Wishlist>>) {
...
export async function POST(req: AuthenticatedMedusaRequest<CreateWishlistInput>, res: MedusaResponse) {
  const customer_id = req?.auth_context?.actor_id;
